...
int main() {
    ...
    for(i = 0; i <= length - digits; i ++) {
        //you could keep the product and simply divide by num[i-1]
        //and them multiply by num[i+ digits]
    ...
    printf("The maximum product is %d, and the index is %d and the digits are %d, %d, %d, %d, %d\n", max, maxIdx, num[maxIdx], num[maxIdx + 1], num[maxIdx + 2], num[maxIdx + 3], num[maxIdx + 4]);
}
